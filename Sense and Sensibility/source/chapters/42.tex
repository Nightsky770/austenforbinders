...
\begin{figure}[tbph]
\centering
\includegraphics[width=\basicwidth]{42child}
...
\begin{letter}
	\begin{figure}[tbph]
		\centering
		\includegraphics[width=\basicwidth]{42lament}
		\caption{The gardener's lamentations}
	\end{figure}
\end{letter}

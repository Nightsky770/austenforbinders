...
\lettrine{M}{rs} Jennings came immediately to their room on her return, and without waiting to have her request of admittance answered, opened the door and walked in with a look of real concern.
...
\begin{letter}
	\begin{figure}[tbph]
		\centering
		\includegraphics[width=\basicwidth]{30fond}
		\caption{How fond he was of it!}
	\end{figure}
\end{letter}

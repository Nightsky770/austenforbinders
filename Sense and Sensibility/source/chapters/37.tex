...
\lettrine{M}{rs} Palmer was so well at the end of a fortnight, that her mother felt it no longer necessary to give up the whole of her time to her; and, contenting herself with visiting her once or twice a day, returned from that period to her own home, and her own habits, in which she found the Miss Dashwoods very ready to resume their former share.
...
\begin{figure}[tbph]
\centering
\includegraphics[width=\basicwidth]{37whisper}
...
\begin{letter}
	\begin{figure}[tbph]
		\centering
		\includegraphics[width=\basicwidth]{37haveheard}
		\caption{<You have heard, I suppose>}
	\end{figure}
\end{letter}
...
\begin{figure}[tbph]
\centering
\includegraphics[width=\basicwidth]{37talking}

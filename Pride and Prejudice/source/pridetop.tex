...
\includepdf[width=.5\textwidth]{halftitle.png}
 \includepdf[addtolist={1,figure,Frontispiece: Reading Jane's Letters,frontispiece},width=1.1\textwidth]{frontispiece.png}
 \includepdf[addtolist={1,figure,Title Page,titlepage},width=1.2\textwidth]{titlepage.jpg}

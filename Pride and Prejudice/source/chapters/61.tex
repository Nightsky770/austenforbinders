...
% \begin{a4}
	% \begin{tikzpicture}[remember picture, overlay]  
		% \node (theend) at ($(current page.south)+(0cm,4cm)$) {\includegraphics[width=.35\linewidth]{theend}};
	% \end{tikzpicture}
...
% \begin{letter}
	% \begin{tikzpicture}[remember picture, overlay]  
		% \node (theend) at ($(current page.south)+(0cm,5cm)$) {\includegraphics[width=.45\linewidth]{theend}};
	% \end{tikzpicture}
	% \captionof{figure}[The End]{}
% \end{letter}
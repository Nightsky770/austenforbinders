...
\begin{figure}[t!]
\centering
\includegraphics[width=\linewidth]{18dancing}
\captionlistentry{When the dancing recommenced}
\end{figure}
...
\begin{figure}[tbh]
\centering
\includegraphics[width=.8\linewidth]{18superior}
\captionlistentry{<Such very superior dancing is not often seen>}
\end{figure}

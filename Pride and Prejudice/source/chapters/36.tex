...
{%
	\begin{frame}{}
	  \begin{tikzpicture}[remember picture, overlay]
		...
		\node[left] at ($(current page.north)+(-2.67cm,-9.7cm)$) {\includegraphics[width=.27\linewidth]{36sword}};
%		\node[left] at ($(current page.west)+(4.73cm,0.775cm)$) {\includegraphics[width=.27\linewidth]{36sword}};
	...
	%\centering
	\flushright
	\includegraphics[width=.65\linewidth]{36top}
	\captionlistentry{Headpiece to Chapter \thechapter}
	\end{figure}
}{%
	\begin{frame}{}
	  \begin{tikzpicture}[remember picture, overlay]
		\node[left] at ($(current page.west)+(4.58cm,1.7cm)$) {\includegraphics[width=.27\linewidth]{36sword}};
	  \end{tikzpicture}
	\end{frame}
...
%		\includegraphics[width=.2\linewidth]{36sword}	
%	\end{scope}
%	\begin{scope}[xshift=8cm]
%		\includegraphics[width=.5\linewidth]{36top}
%		\captionlistentry{Headpiece to Chapter \thechapter}  
%	\end{scope}
...
\begin{figure}[tbph]
\centering
\includegraphics[width=\linewidth]{36town}
\captionlistentry{Meeting accidentally in town}
\end{figure}

...
\makeatletter
\renewcommand*{\chapterheadstartvskip}{\vspace{\@tempskipa}} %reset vskip to default after scootching up TOC header
\makeatother
...
\textit{Emma} was first published in December 1815 by John Murray, credited only to »the Author of \textit{Pride \& Prejudice}«. It was not republished under Jane Austen's (1775\textendash1817) own name until after her death. Illustrations by Hugh Thomson (1860\textendash1920) are from the 1896 edition published by Macmillan and Co., Ltd., in London (UK). Grateful acknowledgement is made to the Internet Archive, which in 2008 digitised a copy of this edition belonging to the University of California.
\end{minipage}
\vfill
